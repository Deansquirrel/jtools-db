...
public class ToolsHelperImpl implements IToolsDbHelper {
    ...
    public ToolsHelperImpl(@Qualifier(value = IToolsDbHelper.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate, @Qualifier(value = "dynamicRoutingDataSourceDynamic") DynamicRoutingDataSource dynamicRoutingDataSource) {
